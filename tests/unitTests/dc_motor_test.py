...
class TestDCMotor:
    ...
    def test_dc_motor_initial_state(self, motor):
    ...
    def test_dc_motor_set_manipulated_variable(self, motor):
    ...
    def test_dc_motor_reset_state(self, motor):
        motor.set_manipulated_variable(5.0)
    ...
    def test_dc_motor_update_state(self, motor):
        motor.set_manipulated_variable(5.0)
        motor.update_state(0.01)
    ...
    def test_dc_motor_get_methods(self, motor):
        motor.set_manipulated_variable(5.0)
        motor.update_state(0.01)
        assert (
